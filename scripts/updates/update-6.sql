...
VALUES (1, 'READ', 'TEMPERATURE', '{}', NOW(), NOW(), '{"type": "cyclic", "every": "20S"}', 'Read temperature from Area 1', 0, 'ACTIVE');


INSERT INTO actions (area_id, verb, object, options, last_run_time, next_run_time, schedule, description, is_running, status)
VALUES (2, 'READ', 'HUMIDITY', '{}', NOW(), NOW(), '"type": "cyclic", "every": "10S"}', 'Read humidity from Area 2', 0, 'ACTIVE');
